...
The body is generated by the LLM (shared configured gateway route in
...
def generate_sms_body(snap: Snapshot) -> tuple[str, bool]:
    ...
    Tries the LLM first (shared gateway route); on any failure falls back to
    ...
    try:
        ...
        log.warning("sms_report_degraded", error_class=type(exc).__name__,
                    error=sanitize(exc, limit=200))
