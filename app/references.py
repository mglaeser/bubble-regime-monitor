...
REGISTRY: dict[str, Methodology] = {
    ...
    "s4": Methodology(
        ...
        why=(
            ...
            "gauge: measured with exuber 1.1.0 on NOMINAL native Nasdaq-100 monthly log levels "
            "from 1986 (T=487) — the SCORED family, since the scored path applies no deflation — "
            "the GSADF is 2.5837 against a 95% CV of 2.2604 — a rejection — but "
            "the window attaining it ends 2000-02, while the BSADF at the 2026-07 endpoint is 1.1315 "
            "against an endpoint 90% CV of 1.1769 (the CPI-deflated shadow gives 2.6189 and 0.7562: "
            "same story, never scored). On that history the supremum would date the "
            ...
            "performs. On the 360-month tail it does fit, the same series gives GSADF 1.4936 "
            "against cv95 2.2099: no rejection, sup dated 2021-08. The endpoint returns 1.1315 "
