...
TEST_FIXTURE_UNAUTHORIZED = "TEST_FIXTURE_UNAUTHORIZED"  # pragma: allowlist secret -- a state NAME
...
VERIFIED_LITERAL_AUTHORIZATION = "VERIFIED_LITERAL_AUTHORIZATION"  # pragma: allowlist secret -- a class NAME
VERIFIED_OPERATOR_PIN_AUTHORIZATION = "VERIFIED_OPERATOR_PIN_AUTHORIZATION"  # pragma: allowlist secret -- a class NAME
