<!-- GENERATED canonical concatenation (§8). Regenerate when a volume
     changes; hash attested in governance/mandate/manifest.json.
     Part 2's text is NOT in-repo (see manifest.json 'part2') — its 40
     Track C checks are nonetheless active in the catalogue and carry
     verdicts in audit/03-findings.json from the founding engagement. -->
