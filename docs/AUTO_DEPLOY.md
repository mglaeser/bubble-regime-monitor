...
| Two deploys at once | Can't happen — `flock` serializes; a trigger during a deploy waits for the lock (up to `LOCK_WAIT_S`, default 1800 s) and causes exactly one more deploy afterward. |
